...
```Bash
bash <(curl -sL https://raw.githubusercontent.com/1731134683x/IP-Sentinel/main/core/install.sh)
...
```Bash
bash <(curl -sL https://raw.githubusercontent.com/1731134683x/IP-Sentinel/main/master/install_master.sh)
